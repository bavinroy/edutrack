...
from Staff_profile import views
from Staff_profile.views import StaffProfileListView
...
urlpatterns = [
    ...
    path("profile/<int:pk>/", views.StaffProfileDetailView.as_view(), name="staff-profile-detail"),
