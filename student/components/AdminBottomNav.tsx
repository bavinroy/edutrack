    ...
    return (
        <View style={styles.container}>
            <View style={[styles.navBar, { backgroundColor: themeColors.card, borderTopColor: themeColors.border }]}>
                <NavIcon path="/admin/dashboard" icon="grid-outline" activeIcon="grid" label="Home" />
                <NavIcon path="/admin/requests" icon="git-pull-request-outline" activeIcon="git-pull-request" label="Requests" />
                <NavIcon path="/admin/notice" icon="megaphone-outline" activeIcon="megaphone" label="Notices" />
                <NavIcon path="/admin/departments" icon="business-outline" activeIcon="business" label="Depts" />
                <NavIcon path="/admin/profile" icon="person-outline" activeIcon="person" label="Profile" />
            </View>
        </View>
    );
}
