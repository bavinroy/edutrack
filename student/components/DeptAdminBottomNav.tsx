...
export default function DeptAdminBottomNav() {
    ...
    const isActive = (path: string) => {
        ...
        if (path !== "/dept_admin/dashboard" && pathname.startsWith(path)) return true;
        return false;
    };
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.navBar, { backgroundColor: themeColors.card, borderTopColor: themeColors.border }]}>
                <NavIcon path="/dept_admin/dashboard" icon="grid-outline" activeIcon="grid" label="Home" />
                <NavIcon path="/dept_admin/requests" icon="git-pull-request-outline" activeIcon="git-pull-request" label="Requests" />
                <NavIcon path="/dept_admin/notice" icon="megaphone-outline" activeIcon="megaphone" label="Notices" />
                <NavIcon path="/dept_admin/staff_list" icon="people-outline" activeIcon="people" label="Staff" />
                <NavIcon path="/dept_admin/profile" icon="person-outline" activeIcon="person" label="Profile" />
            </View>
        </View>
    );
}
