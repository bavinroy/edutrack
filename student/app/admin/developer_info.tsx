...
export default function AdminDeveloperInfo() {
  ...
  const techStack = [
    ...
    { name: "Expo", icon: "flash", color: "#6366F1" },
    { name: "Django REST", icon: "api", color: "#092E20" },
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: themeColors.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollBody} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.introBox}>
          ...
          <Text style={[styles.appTitle, { color: themeColors.text }]}>EduTrack Admin</Text>
          <Text style={[styles.appVersion, { color: themeColors.subText }]}>Version 2.1.0 (Enterprise Release)</Text>
          <Text style={[styles.appDescription, { color: themeColors.subText }]}>
            EduTrack Enterprise is a specialized administrative suite designed for institutional leadership. 
            Empowering administrators with real-time data control and academic oversight.
          </Text>
        </View>
        ...
        {developers.map((dev, idx) => (
          <View key={idx} style={[styles.devCard, { backgroundColor: themeColors.card, borderColor: themeColors.border }]}>
            <View style={[styles.devIconBox, { backgroundColor: isDark ? '#1E293B' : '#EEF2FF' }]}>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 10, fontWeight: '900', letterSpacing: 2, marginBottom: 20, marginLeft: 5, textTransform: 'uppercase' },
  ...
  devRole: { fontSize: 12, fontWeight: '900', marginVertical: 4, textTransform: 'uppercase' },
  devDesc: { fontSize: 13, lineHeight: 20, opacity: 0.9 },
  ...
  techName: { fontSize: 10, fontWeight: '700', marginTop: 8, textAlign: 'center' },
