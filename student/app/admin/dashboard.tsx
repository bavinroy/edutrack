    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerIcons}>
          <TouchableOpacity onPress={() => handleNav("/admin/notifications")}>
            <Ionicons
      ...
      <View style={styles.menu}>
        ...
        <TouchableOpacity
          style={styles.menuButton}
          onPress={() => handleNav("/admin/notice")}
        >
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity onPress={() => handleNav("/admin/dashboard")}>
          <Ionicons name="home" size={24} color="#fff" />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleNav("/admin/requests")}>
