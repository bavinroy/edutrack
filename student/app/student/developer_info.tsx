    ...
    <SafeAreaView style={[styles.container, { backgroundColor: themeColors.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollBody} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.introBox}>
          <View style={[styles.logoCircle, { backgroundColor: '#3B82F6' }]}>
        ...
        {developers.map((dev, idx) => (
          <View key={idx} style={[styles.devCard, { backgroundColor: themeColors.card, borderColor: themeColors.border }]}>
            <View style={[styles.devIconBox, { backgroundColor: isDark ? '#1E293B' : '#EFF6FF' }]}>
              <Ionicons name={dev.icon as any} size={24} color="#3B82F6" />
            </View>
            <View style={styles.devInfo}>
              <Text style={[styles.devName, { color: themeColors.text }]}>{dev.name}</Text>
              <Text style={[styles.devRole, { color: '#3B82F6' }]}>{dev.role}</Text>
        ...
        <TouchableOpacity
          style={[styles.contactCard, { backgroundColor: '#3B82F6' }]}
