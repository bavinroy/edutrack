...
export default function BulkUploadScreen() {
    ...
    // We can fetch role if we want to be safe, but this file is usually only for Staff. 
    // Just in case shared, we fetch or assume defaults.
    const [userRole, setUserRole] = useState<string | null>('DEPT_STAFF');
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <ScrollView style={styles.modalBody}>
                            ...
                            <Text style={styles.noteText}>
                                Note: You are restricted to creating Students for your own department only.
                            </Text>
...
const styles = StyleSheet.create({
    ...
    errorText: { color: '#d32f2f', fontSize: 13, marginBottom: 4 },
